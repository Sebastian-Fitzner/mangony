	...
	bindEvents() {
		...
		let renderPage = (function (obj) {
			...
			.then((fileData) => {
				...
				if (obj.evt === 'add') {
					this.events.emitEvent(this.events.EVENTS.route.register, {
						id: fileData.id,
		...
		this.events.registerEvent(this.events.EVENTS.pages.add, renderPage);
		this.events.registerEvent(this.events.EVENTS.pages.changed, renderPage);
		this.events.registerEvent(this.events.EVENTS.pages.delete, deleteFromCache);
		this.events.registerEvent(this.events.EVENTS.data.add, renderPagesData);
		this.events.registerEvent(this.events.EVENTS.data.changed, renderPagesData);
		this.events.registerEvent(this.events.EVENTS.data.delete, deleteFromCache);
		this.events.registerEvent(this.events.EVENTS.partials.add, renderPagesPartials);
		this.events.registerEvent(this.events.EVENTS.partials.changed, renderPagesPartials);
		this.events.registerEvent(this.events.EVENTS.partials.delete, deleteFromCache);
		this.events.registerEvent(this.events.EVENTS.layouts.add, renderPagesLyt);
		this.events.registerEvent(this.events.EVENTS.layouts.changed, renderPagesLyt);
		this.events.registerEvent(this.events.EVENTS.layouts.delete, deleteFromCache);
	}

	reloader() {
		this.events.emitEvent(this.events.EVENTS.cache.updated);
	}
