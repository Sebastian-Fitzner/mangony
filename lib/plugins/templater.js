...
class Templater {
	...
	renderOne(obj) {
		...
		console.log('obj.cache[`${obj.page.filename}.settings`]: ', obj.cache[`${obj.page.filename}.settings`]);
		let pageSrcExt = obj.page.srcExt || '';
		let pageContent = obj.page.parsed.content;
		let pageData = obj.cache[`${obj.page.filename}.settings`] || obj.page.parsed.data || {};
