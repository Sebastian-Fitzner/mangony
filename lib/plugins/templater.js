...
class Templater {
	...
	registerPartial(obj) {
		return new Promise(function (resolve) {
			let registerPartial = handlebars.registerPartial(obj.file, obj.template);
	...
	registerHelper(obj) {
		return new Promise(function (resolve) {
			let helperFile = require(path.resolve(obj.file));

			let registerHelper = handlebars.registerHelper(helperFile.register(handlebars));
